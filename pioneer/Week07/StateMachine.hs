...
-------------------------------------------------------------------------------------------------------------------------------------
- For constraints, see: https://staging.plutus.iohkdev.io/doc/haddock/plutus-ledger/html/Ledger-Constraints.html#v:mustIncludeDatum
-
-
-
--------------------------------------------------------------------------------------------------------------------------------------
{-# INLINABLE transition #-}
transition :: Game -> State GameDatum -> GameRedeemer -> Maybe (TxConstraints Void Void, State GameDatum)          -- Interpret State GameDatum as State.GameDatum
transition game s r = case (stateValue s, stateData s, r) of             -- Case statemnt expression
    (v, GameDatum bs Nothing, Play c)                                    -- Case statement pattern match
